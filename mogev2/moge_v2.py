...
MODEL_CONFIGS = {
    ...
    "vitb_dinov2": {
        ...
        "neck": {
            "dim_in": [770, 2, 2, 2, 2],
            "dim_out": None,
            "dim_res_blocks": [768, 192, 96, 48, 24],
            "num_res_blocks": [0, 2, 2, 2, 0],
            "res_block_in_norm": "none",
            "res_block_hidden_norm": "none",
            "resamplers": [
        ...
        "scale_head": {"dims": [768, 768, 768, 1]},
        "remap_output": "exp",
        "num_tokens_range": [1200, 3600],
    },
    "vits_dinov2": {
        "encoder": {
            "backbone": "vits_dinov2",
            "intermediate_layers": [2, 5, 8, 11],
            "dim_out": 384,
        },
        "neck": {
            "dim_in": [386, 2, 2, 2, 2],
            "dim_out": None,
            "dim_res_blocks": [384, 96, 48, 24, 12],
            "num_res_blocks": [0, 2, 2, 2, 0],
            "res_block_in_norm": "none",
            "res_block_hidden_norm": "none",
            "resamplers": [
...
class HyDenMoGe(MoGeModel):
    ...
    def __init__(self, cnn_encoder: str = "large_htp", **kwargs) -> None:
