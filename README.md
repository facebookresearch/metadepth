...
- **[May 21, 2026]** Released HyDen-MoGeV2 model code and checkpoints for [metric 3D point maps](https://huggingface.co/facebook/hyden-mogev2-metric-point) and [surface normal prediction](https://huggingface.co/facebook/hyden-mogev2-surface-normal).
...
| HyDen-MoGeV2-Large-Surface-Normal | Surface normal prediction | [HuggingFace](https://huggingface.co/facebook/hyden-mogev2-surface-normal) |
| HyDen-MoGeV2-Large-Metric-Point | Metric 3D point estimation | [HuggingFace](https://huggingface.co/facebook/hyden-mogev2-metric-point) |
